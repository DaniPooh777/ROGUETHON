...
# Tecla para esperar la acción (solo la tecla ESPACIO)
WAIT_KEYS = {
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.print(
            x=x + 1,
            y=5,
            string=f"a) Salud (+20 HP)",
        )
        console.print(
            x=x + 1,
            y=6,
            string=f"b) Fuerza (+1 fuerza)",
        )
        console.print(
            x=x + 1,
            y=7,
            string=f"c) Defensa (+1 defensa)",
        )
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        if number_of_items_in_inventory > 0:
            for i, item in enumerate(self.engine.player.inventory.items):
                ...
                if is_equipped:
                    item_string = f"{item_string} (Equipado)"
...
class InventoryActivateHandler(InventoryEventHandler):
    ...
    TITLE = "   Selecciona un item a usar   "
...
class InventoryDropHandler(InventoryEventHandler):
    ...
    TITLE = "   Selecciona un item a soltar   "
