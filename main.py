...
import core.exceptions as exceptions  # Excepciones personalizadas del juego.
from core import setup_game  # Configuración inicial del juego.
from ui import input_handlers  # Gestión de entrada y eventos del usuario.
...
tileset_path = os.path.join(base_path, "assets", "fonts", "dejavu10x10_gs_tc.png")
