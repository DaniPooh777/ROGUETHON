...
from components.base_component import (
    BaseComponent,
)  # Importa la clase BaseComponent que será la clase base de todos los componentes
...
if TYPE_CHECKING:
    ...
    from entities.entity import (
        Actor,
        Item,
    )  # Importa las clases Actor y Item para el tipo de 'parent' y 'items' en la clase Inventory
...
class Inventory(BaseComponent):
    ...
    def __init__(self, capacity: int):
        ...
        self.items: List[
            Item
        ] = []  # Lista de objetos que el actor tiene en el inventario
