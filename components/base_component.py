...
from __future__ import (
    annotations,
)  # Importación de la futura compatibilidad con anotaciones de tipo en clases y métodos.
from typing import (
    TYPE_CHECKING,
)  # Importa TYPE_CHECKING, utilizado para importar clases solo cuando se realiza la comprobación de tipos estáticos.
...
if TYPE_CHECKING:
    from core.engine import (
        Engine,
    )  # La clase Engine se importa solo para la comprobación de tipos.
    from entities.entity import (
        Entity,
    )  # La clase Entity se importa solo para la comprobación de tipos.
    from core.game_map import (
        GameMap,
    )  # La clase GameMap se importa solo para la comprobación de tipos.
...
class BaseComponent:
    ...
    def engine(self) -> Engine:
        ...
        return (
            self.gamemap.engine
        )  # Retorna el motor de juego asociado al mapa de juego de la entidad.
